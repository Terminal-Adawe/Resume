  ...
  <div class="container" style="font-size: 21px; font-family: 'Times New Roman'">
      ...
      <div class="d-flex justify-content-center my-4" style="background-color: white;padding-top: 8px; padding-bottom: 8px;">
        ...
        @foreach($fonts as $font)
          @if($font == $data['properties']->font)
            <span class="template_color mx-2 dropdown-toggle" id="fontSelector" data-bs-toggle="dropdown" aria-expanded="false">{{ $font }}</span>
          @endif
        @endforeach
    ...
    <div class="row my-4">
      <div class="col-9 col-sm-9 col-lg-9">
        ...
        <div class="row">
          <div class="col">
            <h5 class="theme-color" style="color: {{ $data['properties']->color1 }}">SUMMARY</h5>
            <p>
        ...
        <div class="row my-4">
          <div class="col">
            <h5 class="theme-color" style="color: {{ $data['properties']->color1 }}">EXPERIENCE</h5>
        ...
        <div class="row my-4">
          <div class="col">
            <h5 class="theme-color" style="color: {{ $data['properties']->color1 }}">EDUCATION</h5>
      ...
      <div class="col-3 col-sm-3 col-lg-3">
        <div class="row">
          @if($data['skills'])
          <div class="col-12">
            <h5 class="theme-color" style="color: {{ $data['properties']->color1 }}">SKILLS</h5>
            <ul>
          ...
          <div class="col-12 my-4">
            <h5 class="theme-color" style="color: {{ $data['properties']->color1 }}">HOBBIES</h5>
            <ul>
