...
<body style="width: 100%; position: relative; margin:0; padding: 0;">
  ...
  <!-- Heading -->
    ...
    <div class="row my-4">
        ...
        <div class="row my-4">
          <div class="col-lg-12 col-lg-12">
            ...
            <div class="row">
              ...
              <div class="col-lg-12 col-lg-12 mt-3">
                <div class="ml-4">
                  <ul>
      ...
      <div class="col-lg-3 col-lg-3">
        <div class="row">
          ...
          @if($data['hobbies'])
          <div class="col-lg-12 col-lg-12 my-4">
    ...
    <div class="row">
        ...
        <a href="{{ route('export.pdf') }}" class="btn btn-outline-info btn-lg btn-block mt-4">Print</a>

    </div>
  </div>

  <script src="{{ public_path('bootstrap-4.3.1-dist/js/bootstrap.min.js') }}"></script>
</body>
@endsection